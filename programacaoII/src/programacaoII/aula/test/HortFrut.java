...
/*Esta aplicação dá ao usuário a opção de imprimir as listas,
 * adicionar uma nova fruta junto de sua quantidade, caso o 
 * usuário forneça uma fruta que já exisat na lista, apenas
 * a quantidade é aceita e somada com a quantidade existente
 * daquela fruta, o código reage bem a exceções*/
