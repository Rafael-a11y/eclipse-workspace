...
/*Uma claasse DeadLockTest que contém dois objetos estáticos, junto de uma outra classe estática, ou seja, 
 * DeadLockTest.ThreadExemplo1, ThreadExemplo1 extends Thread, dentro do run(), lock1 e lock são synchronized*/
