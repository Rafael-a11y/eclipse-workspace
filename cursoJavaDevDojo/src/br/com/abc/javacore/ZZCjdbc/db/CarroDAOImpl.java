...
public class CarroDAOImpl implements CarroDAO{
	...
	/*Por não ser ser cláusula like, não precisa usar '%'*/
	@Override
	...
	/*Por se usar cláusula like, usa-se '%String%', mas esta concatenação deve ser usada na hora
	 * de setar a string, o caracter coringa (?) continua intacto na String sql*/
	@Override
