...
public class Teste {public static void main(String[] args) {
	...
	System.out.println("\nEntre com um segundo número inteiro: ");
	int numero1 = entrada.nextInt();
	entrada.close();
	if ((numero + numero1 <= 30 && numero + numero1 >= 0)||(numero + numero1 == 32 || numero + numero1 == 40 || numero + numero1 == 50
			|| numero + numero1 == 60)) {
		System.out.printf("\nO número %d é menor OU igual que 30, OU, é maior que 30 mas está dentro de um dos valores que são aceitos"
				+ " fora do range", numero + numero1);
	}
//	else if (numero + numero1 == 32 || numero + numero1 == 40 || numero + numero1 == 50 || numero + numero1 == 60) {
//		System.out.printf("\nO número %d é maior que 30 mas cai dentro dos valores aceitos fora do range.", numero + numero1);
	}
