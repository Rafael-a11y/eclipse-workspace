...
public class DesafioFilter {
	public static void main(String[] args) {
		...
		System.out.println("Grande promocão, lista de produtos\n"
				+ "que estão com frete gratuito e com desconto\n"
				+ "acima de 30%!!!");
...
//		System.out.println(produto2.preco);
		//interfaces sempre usam generics para declarar os parâmetros
