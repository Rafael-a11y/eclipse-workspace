...
//		painelFundo2.setLayout(new GridLayout(2,1));
		...
		//Criando o JTable fornecendo de parâmetro o array e matriz
...
//		barraRolagem2 = new JScrollPane(tabela2);
		//Adicionando o JScrollPane ao painél
		painelFundo.add(barraRolagem);
//		painelFundo2.add(barraRolagem2);
//		painelFundo.add(painelFundo2);
		
		//VocÊ pode definir o conatiner da janela como o painelFundo ou adicionar
		//vários componentes como vários JPanels
